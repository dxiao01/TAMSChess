...
const Home = () => {
  return (
    <div class="h-section snap-start bg-home-bg bg-no-repeat bg-cover" id="home">
        <div class="max-w-6xl px-12 mx-auto text-center pt-12">
            <div class="space-y-12 mtext-center bg-gray-800 rounded-lg">
                <div class="max-w-3xl mb-10 space-y-5 mx-auto pt-10">
